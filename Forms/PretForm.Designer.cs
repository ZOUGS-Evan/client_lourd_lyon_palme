namespace LyonPalme.Forms
{
    partial class PretForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.lblTitre.Text = "📤  Enregistrer un prêt";
            ...
            // Adhérent
            L(this.lblAdherentLib, "Adhérent *", x, y);
            ...
            // Matériel
            L(this.lblMaterielLib, "Matériel disponible *", x, y);
            ...
            // Date
            L(this.lblDateLib, "Date du prêt *", x, y);
