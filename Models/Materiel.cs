...
namespace LyonPalme.Models
{
    ...
    ///               Encapsule les données et délègue les opérations CRUD à DBInterface (statique).
    /// </summary>
    public class Materiel
    {
        ...
        /// <summary>Indique si le matériel est actuellement disponible au prêt.</summary>
        public bool EstDisponible()
        {
            return string.Equals(Disponibilite, "Disponible", StringComparison.OrdinalIgnoreCase);
        }

        /// <summary>Indique si le matériel est hors service.</summary>
        public bool EstHorsService()
        {
            return string.Equals(Etat, "Hors service", StringComparison.OrdinalIgnoreCase);
        }
        ...
        public void Ajouter()
        {
            ...
            string taille = string.Equals(TypeMateriel, "Monopalme", StringComparison.OrdinalIgnoreCase)
                            ? null : TailleOuPointure;

            Id = DBInterface.AjouterMateriel(nextId, Code, Marque, Etat, TypeMateriel,
                                             pointure, Materiaux, taille, TenuSaison);
        }

        /// <summary>Modifie ce matériel en base.</summary>
        public void Modifier()
        {
            ...
            DBInterface.ModifierMateriel(Id, Code, Marque, Etat,
                                         pointure, Materiaux, taille, TenuSaison);
        }
        ...
        public void Supprimer()
        {
            ...
            DBInterface.SupprimerMateriel(Id);
        }

        /// <summary>Recharge les données de ce matériel depuis la base.</summary>
        public void Rafraichir()
        {
            MaterielDTO dto = DBInterface.GetDetailsMateriel(Id);
            if (dto == null)
